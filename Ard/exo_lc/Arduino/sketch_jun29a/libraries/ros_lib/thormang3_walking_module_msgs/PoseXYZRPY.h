#ifndef _ROS_thormang3_walking_module_msgs_PoseXYZRPY_h
#define _ROS_thormang3_walking_module_msgs_PoseXYZRPY_h
...
namespace thormang3_walking_module_msgs
{
  ...
  class PoseXYZRPY : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "thormang3_walking_module_msgs/PoseXYZRPY"; };
