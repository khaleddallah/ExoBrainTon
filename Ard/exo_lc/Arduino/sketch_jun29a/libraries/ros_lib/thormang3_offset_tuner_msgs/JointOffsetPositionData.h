#ifndef _ROS_thormang3_offset_tuner_msgs_JointOffsetPositionData_h
#define _ROS_thormang3_offset_tuner_msgs_JointOffsetPositionData_h
...
namespace thormang3_offset_tuner_msgs
{
  ...
  class JointOffsetPositionData : public ros::Msg
  {
    public:
      ...
      typedef float _present_value_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->present_value);
      union {
        int32_t real;
        uint32_t base;
      } u_p_gain;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->present_value));
      union {
        int32_t real;
        uint32_t base;
      } u_p_gain;
    ...
    const char * getType(){ return "thormang3_offset_tuner_msgs/JointOffsetPositionData"; };
    const char * getMD5(){ return "7fa2aed3bed37b6302a45de21d81e20b"; };
